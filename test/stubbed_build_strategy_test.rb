...
class StubbedBuildProxyTest < Test::Unit::TestCase

  context "with a class to stubbed build" do
    setup do
      @class       = Class.new
    ...
    context "the stubbed build proxy" do
      setup do
        @proxy = Factory::Proxy::StubbedBuild.new(@class)
      end
