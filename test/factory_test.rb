...
class FactoryTest < Test::Unit::TestCase
  ...
  context "after defining a factory" do
    ...
    should "use Proxy::StubbedBuild for Factory.stubbed_build" do
      @factory.
        expects(:run).
        with(Factory::Proxy::StubbedBuild, :attr => 'value').
        returns('result')
      assert_equal 'result', Factory.stubbed_build(@name, :attr => 'value')      
    end
    ...
    [:build, :create, :stubbed_build, :attributes_for].each do |method|
